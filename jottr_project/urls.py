"""
URL configuration for jottr_project project.
...
# that forwards visitors straight to our notes app's own internal signpost directory list!
...
urlpatterns = [
    ...
    # We include our notes app's URLs at the empty root path of our website!
    # When a visitor goes to the base URL http://127.0.0.1:8000/, this entry forwards
    # them directly to the internal notes/urls.py file to find the correct view function!
